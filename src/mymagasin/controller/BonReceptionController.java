 ...
 * @author on
 */
public class BonReceptionController implements Initializable {
    ...
    @FXML
     ...
     @FXML
    private void save_BR_Contenet(MouseEvent event) throws SQLException {
    ...
    private void initU(MouseEvent event) {
     ...
     @FXML
    private void printBR(MouseEvent event) throws IOException {
        String fileName = "bon_Recption"+ ".pdf";
        PDDocument doc = null;
        try
        {
          doc = new PDDocument();
